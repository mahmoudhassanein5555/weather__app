...
class _SearchResultScreenState extends State<SearchResultScreen> {
  ...
  void initState() {
    ...
    weather = repository.getWeather( cityName: widget.cityName);
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Color(0xFF642FF1)),
      body:  FutureBuilder(
              future: weather,
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                Column(
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        color: const Color.fromARGB(255, 232, 232, 10),
                                        fontSize: 20,
                                        fontWeight: FontWeight.w900,
                                      ),
                                    ),
                                ...
                                // Container(height: 100, width: 100, child: Image.asset("lib/images/arrows.png"),),
                              ],
                            ),
                          ),
                        ],
